...
require 'includes/script-about-section2.php';
            ...
            <div class="page-wrapper">
                ...
                <div class="page-header card">
                    <div class="card-block">
                        ...
                        <p class="text-muted m-b-10">Espace d'enregistrement About-section2</p>
                        <ul class="breadcrumb-title b-t-default p-t-10">
                            <li class="breadcrumb-item">
                                <a href="index.php?id=<?php echo
                                                            $_SESSION['id'] ?>"> <i class="fa fa-home"></i> </a>
                            </li>
                            <li class="breadcrumb-item"><a href="#!">Section2</a>
                            </li>
                            <li class="breadcrumb-item"><a href="#!">Nouvel Section</a>
                            </li>
                            <li class="breadcrumb-item "><button class="btn btn-success" type=" submit" onclick="window.location.href='list-about-section2.php?id=<?php echo $_SESSION['id'] ?>';">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="nom" type="text" class="form-control" id="inputAddress" required=""></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail4">Poste</label>
                                                <input name="poste" type="text" class="form-control" id="inputEmail4" placeholder="" required="">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail4">Contact</label>
                                                <input name="contact" type="text" class="form-control" id="inputEmail4" placeholder="" required="">
                                            </div>
