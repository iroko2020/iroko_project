...
$colParPage = 5;
$reqColTotal = $bdd->query("SELECT id FROM type3");
...
if (isset($_GET['publier']) and !empty($_GET['publier'])) {
    ...
    $req = $bdd->prepare("UPDATE type3 where id=?");
    $req->execute(array($publier));
}
if (isset($_GET['supprime']) and !empty($_GET['supprime'])) {
    $supprime = (int) $_GET['supprime'];
    $req = $bdd->prepare("DELETE FROM type3 where id=?");
            ...
            <div class="page-wrapper">
                ...
                <div class="page-header card">
                    <div class="card-block">
                        <h5 class="m-b-10">Type 3</h5>
                        <p class="text-muted m-b-10">Article type 3</p>
                        <ul class="breadcrumb-title b-t-default p-t-10">
                            <li class="breadcrumb-item">
                                <a href="index.php?id=<?php echo
                                                            $_SESSION['id'] ?>"> <i class="fa fa-home"></i> </a>
                            </li>
                            <li class="breadcrumb-item"><a href="#!">Type 3</a>
                            </li>
                            <li class="breadcrumb-item"><a href="#!">Liste des articles</a>
                            </li>
                            <li class="breadcrumb-item "><button class="btn btn-success" type="submit" onclick="window.location.href='type3.php?id=<?php echo $_SESSION['id'] ?>';">
                        ...
                        <div class="card-block table-border-style">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <?php
                                    $liste = $bdd->query('SELECT * FROM type3 ORDER BY date_time_publication ASC LIMIT ' . $depart . ',' . $colParPage);
                                    while ($l = $liste->fetch()) {
                                    ...
                                    ?>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="padding-top: 50px"><?= $l['icon1'] ?></td><br>
                                                <td style="padding-top: 50px"><?= $l['icon2'] ?></td><br>
                                                <td style="padding-top: 50px"><?= $l['icon3'] ?></td><br>
                                                <td style="padding-top: 50px"><?= $l['icon4'] ?></td><br>
                                                    ...
                                                    for ($i = 1; $i <= $pageTotale; $i++) {
                                                        ...
                                                        <?php
                                                            ...
                                                            <li class="page-item">
                                                                <span class="page-link">
                                                            <?php
                                                            echo '<a href="list-type3?id=' . $_SESSION['id'] . '&page=' . $i . '">' . $i . '</a>';
                                                        }
                                                    }
