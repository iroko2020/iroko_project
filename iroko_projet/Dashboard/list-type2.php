...
$colParPage = 5;
$reqColTotal = $bdd->query("SELECT id FROM type2");
...
if (isset($_GET['publier']) and !empty($_GET['publier'])) {
    ...
    $req = $bdd->prepare("UPDATE type2 where id=?");
    $req->execute(array($publier));
}

if (isset($_GET['supprime']) and !empty($_GET['supprime'])) {
    $supprime = (int) $_GET['supprime'];
    $req = $bdd->prepare("DELETE FROM type2 where id=?");
            ...
            <div class="page-wrapper">
                ...
                <div class="page-header card">
                    <div class="card-block">
                        <h5 class="m-b-10">Type 2</h5>
                        <p class="text-muted m-b-10">Article type 2</p>
                        <ul class="breadcrumb-title b-t-default p-t-10">
                            ...
                            <li class="breadcrumb-item "><button class="btn btn-success" type="submit" onclick="window.location.href='type2.php?id=<?php echo $_SESSION['id'] ?>';">
                        ...
                        <div class="card-block table-border-style">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <?php
                                    $liste = $bdd->query('SELECT * FROM type2 ORDER BY date_time_publication asc LIMIT ' . $depart . ',' . $colParPage);
                                    while ($l = $liste->fetch()) {
                                                    ...
                                                    for ($i = 1; $i <= $pageTotale; $i++) {
                                                        ...
                                                        <?php
                                                            ...
                                                            <li class="page-item">
                                                                <span class="page-link">
                                                            <?php
                                                            echo '<a href="list-type2?id=' . $_SESSION['id'] . '&page=' . $i . '">' . $i . '</a>';
                                                        }
                                                    }
