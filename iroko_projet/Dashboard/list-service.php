...
$colParPage = 5;
$reqColTotal = $bdd->query("SELECT id FROM services");
...
//     $req = $bdd->prepare("UPDATE services set confirme = 1 where id=?");
//     $req->execute(array($publier));
// }
if (isset($_GET['supprime']) and !empty($_GET['supprime'])) {
    $supprime = (int) $_GET['supprime'];
    $req = $bdd->prepare("DELETE FROM services where id=?");
            ...
            <div class="page-wrapper">
                ...
                <div class="page-header card">
                    <div class="card-block">
                        ...
                        <p class="text-muted m-b-10">Article Service</p>
                        <ul class="breadcrumb-title b-t-default p-t-10">
                            ...
                            <li class="breadcrumb-item "><button class="btn btn-success" type="submit" onclick="window.location.href='service.php?id=<?php echo $_SESSION['id'] ?>';">
                        ...
                        <div class="card-block table-border-style">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <?php
                                    $liste = $bdd->query('SELECT * FROM services ORDER BY date_time_publication ASC LIMIT ' . $depart . ',' . $colParPage);
                                    while ($l = $liste->fetch()) {
                                    ...
                                    ?>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="padding-top: 50px"><?= $l['icon1_titre'] ?></td><br>
                                                <td style="padding-top: 50px"><?= $l['icon1_contenu'] ?></td><br>
                                                <td style="padding-top: 50px"><?= $l['icon2_titre'] ?></td><br>
                                                <td style="padding-top: 50px"><?= $l['icon2_contenu'] ?></td><br>
                                                <td style="padding-top: 50px"><?= $l['icon3_titre'] ?></td><br>
                                                <td style="padding-top: 50px"><?= $l['icon3_contenu'] ?></td><br>
                                                <td style="padding-top: 50px"><?= $l['date_time_publication'] ?></td>
                                                <td style="padding-top: 50px"><?= $l['id'] ?></td>
                                                <td><img src="miniatures/service/<?= $l['id'] ?>.jpg" width="150" height="100"></td>
                                                ...
                                                <td style="padding-top: 40px">
                                                    ...
                                                    <a href="service.php?id=<?php echo
                                                                                $_SESSION['id'] ?>&publier=<?= $l['id'] ?>" style="color: #fff" title="modifier" class="btn btn-out-dotted btn-primary btn-square" onclick="window.alert('Votre section a bien été publié!!')"><span class="ti-marker-alt"></span></a>
                                                    <a href="list-service.php?id=<?php echo
                                                    ...
                                                    for ($i = 1; $i <= $pageTotale; $i++) {
                                                        ...
                                                        <?php
                                                            ...
                                                            <li class="page-item">
                                                                <span class="page-link">
                                                            <?php
                                                            echo '<a href="list-service?id=' . $_SESSION['id'] . '&page=' . $i . '">' . $i . '</a>';
                                                        }
                                                    }
