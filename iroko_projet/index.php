...
<body>
	...
	<div id="wowslider-container1">
		<div class="ws_images">
			<ul>
				<li><img src="data1/images/2.jpg" alt="2" id="wows1_0" /></li>
				<li><img src="data1/images/3.jpg" alt="3" id="wows1_1" /></li>
				<li><a href="http://wowslider.net"><img src="data1/images/4.jpg" alt="jquery carousel" id="wows1_2" /></a></li>
				<li><img src="data1/images/1.jpg" alt="1" id="wows1_3" /></li>
			</ul>
		</div>
					...
					<div class="col-lg-4 col-md-6">
						<div class="feature-item">
							...
							<div class="feature-text">
								...
								<a href="#gal<?= $l['id'] ?>" class="room-price">Plus d'infos</a>
							</div>
						</div>
					</div>

					<div id="gal<?= $l['id'] ?>" class="pop-overlay animate">
						<div class="popup">
		...
		<div class="container">
			...
			<div class="row">
				...
				?>
					<div class="col-md-6">
						...
						<div class="propertie-item set-bg" data-setbg="Dashboard/miniatures/composant/<?= $l['id'] ?>.jpg">
							...
							<div class="propertie-info text-white">
								...
								<div class="price">
									<a href="#suite<?= $l['id'] ?>">Plus d'infos</a>
								</div>
							</div>
						</div>
					</div>
					...
					<!-- pour faire un popup -->
					<!-- popup-->
					<div id="suite<?= $l['id'] ?>" class="pop-overlay animate">
						<div class="popup">
