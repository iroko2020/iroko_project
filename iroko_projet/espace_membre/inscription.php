			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="POST">
					<div class="wrap-input100 validate-input m-b-26">
						...
						<input class="input100" type="text" name="pseudo" placeholder="Entrez votre pseudo..." value="<?php if (isset($pseudo)) {
																															echo $pseudo;
																														} ?>">
					...
					<div class="wrap-input100 validate-input m-b-18">
						...
						<input class="input100" type="email" name="mail1" placeholder="Entrez votre mail" value="<?php if (isset($mail1)) {
																														echo $mail1;
																													} ?>">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-18">
						...
						<input class="input100" type="email" name="mail2" placeholder=" Confirmez votre mail" value="<?php if (isset($mail2)) {
																															echo $mail2;
																														} ?>">
						<span class="focus-input100"></span>
					</div>
